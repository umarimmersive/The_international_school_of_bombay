...
class VidioAlbumsView extends GetView<VidioAlbumsController> {
  const VidioAlbumsView({Key? key}) : super(key: key);
  @override
                        ...
                        child: InkWell(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Flexible(child: GlobalLocalText(text: "${controller.albamname[index]}",fontWeight: FontWeight.w300,size: 14,)),
                             ],
                          ),
                        ),
                      );
