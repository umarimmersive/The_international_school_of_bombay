                    ...
                    SliverList(
                      delegate: SliverChildBuilderDelegate(
                          ...
                          return Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                controller.isLoading_Knowledge == false ?
                                SizedBox(
                                  height: MediaQuery
                                      .of(context)
                                      .size
                                      .height / 3,
                                  child: ListView.builder(
                                      itemCount: controller.KnowledgeBaseList
                                          .length,
                                      scrollDirection: Axis.horizontal,
                                      shrinkWrap: true,
                                      itemBuilder: (BuildContext, index) {
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            onTap: () {
                                              var data = {
                                                'id': controller
                                                    .KnowledgeBaseList[index].id
                                                    .toString(),
                                              };
                                              print('-------------${data}');

                                              Get.toNamed(Routes.ARTICAL1,
                                                  parameters: data);
                                            },
                                            child: Container(
                                              height:
                        ...
                        height: 20,
                                ...
                                controller.isLoading_Event == false ?
                                Padding(
                                ...
                                Shimmer.fromColors(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        width: double.infinity,
                                        child: ListView.builder(
                                            itemCount: controller.Event_list
                                                .length,
                                            shrinkWrap: true,
                                            scrollDirection: Axis.horizontal,
                                            itemBuilder: (BuildContext, index) {
                                ...
                                Padding(
                                  ...
                                  child: Card(
                                    ...
                                    child: Container(
                                      ...
                                      width: double.infinity,
                                      child: Image.network(
                                          ApiService.IMAGE_URL+controller.adv_image.value,fit: BoxFit.fill,),
                                    ),
                                  ),
                                ),
                                    ...
                                    children: [
                                      ...
                                      Center(
                                        child: GlobalLocalText(
                                          ...
                                          fontWeight: FontWeight.bold,
                                          size: 20,
                                          textColor: ColorValues.kRedColor,
                                        ),
                                      ),
                                    ],
                                  ),
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        shrinkWrap: true,
                                        itemCount: controller.slider_image.length,
                                        itemBuilder: (BuildContext, index) {
                                          return Padding(
                                            padding: const EdgeInsets.only(
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        shrinkWrap: true,
                                        itemCount: controller.Announcement_list
                                            .length,
                                        itemBuilder: (BuildContext, index) {
                                          return Padding(
                                            padding: const EdgeInsets.only(
