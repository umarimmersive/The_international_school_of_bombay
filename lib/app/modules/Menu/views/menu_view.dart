                           ...
                           child: Container(
                             ...
                             child: Column(
                               children: [
                                 ...
                                 Expanded(
                                     flex: 2,
                                     child: Text_widget(Simpletext: 'Profile', fontSize: 14.0,color: Colors.black,)
                                 ),
                               ],
                             )
                           ),
                             ...
                             child: Container(
                                 ...
                                 child: Column(
                                   children: [
                                     Expanded(
                                         flex: 2,
                                         child: Image.asset('assets/images/insurance.png',height: 20,width: 20,color: Colors.red,)
                                     ),
                                     Expanded(
                                         flex: 2,
                                         child: Text_widget(Simpletext: 'Policy', fontSize: 14.0,color: Colors.black,)
                                     ),
                                   ],
                                 )
                             ),
